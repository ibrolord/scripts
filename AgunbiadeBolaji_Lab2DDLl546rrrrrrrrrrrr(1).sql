...
insert into WINE_TYPE (wtCode, wtServeTemp, wtName, wtLeadFirst, wtLeadLast) values ('F', 13.0, 'Fortified', 'Ricki', 'Lopez')

UPDATE WINE_TYPE
SET wtName = 'Fortified'
WHERE wtCode = 'F';

drop TABLE wine;

insert into WINE (wineID, wineName, wineYear, winePrice, wineAlcohol, wtCode) values ('23', 'Oak Aged Sherry', '2010', 17.95, 11.5, 'O')
